...
It should be noted that directions of high variance contrasts between two groups can be different from the directions of variation in the pooled data. If there is little variation of data along the relative eigenvectors, the relative eigenvectors would not effectively explain the pattern of variation in the data, irrespective of the absolute value of ratio of generalised variance. In geometric morphometric analysis of ontogenetic series, this corresponds to a situation where although ratio of generalised variance suggests shape variance is developmentally reduced, the observed morphological variation in the pooled sample is minimally affected.

An objective evaluation of results of relative PCA should be complemented by a measure that quantifies the magnitude of variation of pooled data along the directions of relative eigenvectors. We therefore propose RElative STrength Of Relative Eigenvectors (RESTORE), a measure that quantifies shape variance captured by relative eigenvectors. RESTORE would “restore” a contextual understanding of the variance between two groups by shifting attention away from a mere focus on the relative eigenspace to an evaluation of it in the eigenspace spanned by pooled multivariate data.
